...
const CreatorOnboarding = lazy(() => import("./pages/CreatorOnboarding.jsx"));
...
const PartnerSubscription = lazy(() => import("./pages/PartnerSubscription.jsx"));
const PartnerPlanDetail = lazy(() => import("./pages/PartnerPlanDetail.jsx"));
...
const Biglietti = lazy(() => import("./pages/Biglietti"));
          ...
          <Suspense fallback={<PageLoader />}>
            <Routes>
              ...
              >
                ...
                <Route path="/partner/subscription/:tier" element={<PartnerPlanDetail />} />
                ...
                <Route path="/diventa-creator" element={<CreatorOnboarding />} />
                <Route path="/diventa-creator/candidatura" element={<BecomeCreator />} />
