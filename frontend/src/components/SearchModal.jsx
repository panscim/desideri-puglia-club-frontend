    ...
    return (
        <AnimatePresence>
            <motion.div
                ...
                className="fixed inset-0 z-[100] flex flex-col font-satoshi bg-white text-zinc-950"
            >

                {/* HEADER */}
                <div className="flex items-center gap-3 px-4 pt-12 pb-4 border-b bg-white border-zinc-100">
                    <button onClick={onClose} className="p-2 rounded-full transition-colors text-zinc-950 active:bg-zinc-100">
                    ...
                    <div className="flex-1 relative">
                        ...
                        <input
                            ...
                            className="w-full rounded-full py-3 pl-10 pr-10 text-sm focus:outline-none font-geist transition-colors bg-zinc-100 border border-transparent text-zinc-950 placeholder-zinc-400 focus:bg-zinc-50 focus:border-zinc-200"
                            autoFocus
                        />
                ...
                <div className="flex-1 overflow-y-auto no-scrollbar pb-10">
                    ...
                    <div className="px-4 py-6">
                        ...
                        <ul className="flex flex-col">
                            {/* VICINO A TE */}
                            <li className="flex items-center gap-4 py-4 border-b transition-colors cursor-pointer border-zinc-100 active:bg-zinc-50" onClick={() => handleCityClick({ id: 'nearby' })}>
                                ...
                                <div className="flex flex-col">
                                    <span className="font-bold text-[16px] leading-tight text-zinc-950">Vicino a te</span>
                            ...
                            {PUGIA_CITIES.filter(c => c.name.toLowerCase().includes(searchQuery.toLowerCase())).map((city, idx) => (
                                <li
                                    key={city.id}
                                    className={`flex items-center gap-4 py-4 transition-colors cursor-pointer ${idx !== PUGIA_CITIES.length - 1 ? 'border-b border-zinc-100' : ''
                                        } active:bg-zinc-50`}
                                ...
                                >
                                    ...
                                    <div className="flex flex-col">
                                        <span className="font-medium text-[16px] leading-tight text-zinc-900">{city.name}</span>
