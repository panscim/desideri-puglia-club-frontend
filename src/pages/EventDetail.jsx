...
const EventDetail = () => {
  ...
  const handleRequestPermissions = async () => {
    ...
    if (granted) {
      ...
      toast.error("Permesso negato. Controlla le impostazioni del telefono.");
    }
  };
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white font-satoshi selection:bg-orange-500/30 pb-20">
            ...
            <div className={`flex items-center gap-4 p-4 rounded-3xl border transition-all duration-500 ${
              ...
              <div className="flex-1">
                ...
                <p className="text-sm font-bold truncate">
                  {status.isLocationOk ? "Presenza Verificata" : gpsError === true || gpsError ? "Autorizzazione Necessaria" : status.distanceLabel ? `Distanza: ${status.distanceLabel}` : "Ricerca posizione..."}
                </p>
              </div>
              <div className="flex gap-2">
                 {/* Explicit Permission Button */}
                 {!userCoords && (
                    <button 
                      onClick={handleRequestPermissions}
                      className="px-3 py-2 rounded-xl bg-orange-600 text-white text-[10px] font-black uppercase tracking-widest active:scale-95 transition-all"
                    >
                      Consenti
                    </button>
                 )}
        ...
        <section className="space-y-10 mb-20">
          ...
          <div className="grid grid-cols-1 gap-4">
              ...
              <div className="bg-zinc-900/40 p-6 rounded-[2rem] border border-white/5 shadow-xl">
                 ...
                 <p className="text-zinc-300 font-medium italic leading-relaxed text-lg">
                    "{event.descrizione}"
                 </p>
